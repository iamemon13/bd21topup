...
export default function WeeklyLiteTopUpPage() {
        ...
        <div className="grid gap-6 lg:grid-cols-[320px_1fr]">
          ...
          <div className="space-y-5">
            ...
            <div className="rounded-2xl border border-cyan-400/20 bg-[#0b2545] p-5">
              ...
              <div className="flex flex-col gap-3">
                ...
                {!isUidVerified ? (
                  <button
                    ...
                    className="w-full rounded-xl bg-cyan-400 px-6 py-3.5 font-bold text-[#06172e] transition hover:bg-cyan-300 disabled:opacity-50"
                  >
              ...
              {uidError && (
                <div className="mt-3 rounded-xl border border-red-400/20 bg-red-400/10 px-4 py-2.5 text-xs font-semibold text-red-400">✕ {uidError}</div>
              )}
            </div>
            ...
            <div className="rounded-2xl border border-cyan-400/20 bg-[#0b2545] p-5">
              ...
              <div className="space-y-2.5 rounded-xl bg-[#07182f] p-4 text-xs sm:text-sm">
                <div className="flex justify-between gap-4"><span className="text-slate-400">Product</span><span>Weekly Lite</span></div>
