          ...
          <div>
            <div className="overflow-hidden rounded-2xl border border-cyan-400/20 bg-[#0b2545]">
              <Image
                ...
                height={700}
                priority
                src="/products/level-up-pass.png"
                width={700}
              />
            </div>
            <div className="mt-4 rounded-2xl border border-cyan-400/20 bg-[#0b2545] p-5">
              <h1 className="text-2xl font-black">
                Level Up <span className="text-cyan-400">Pass</span>
              </h1>
              <p className="mt-2 text-sm leading-6 text-slate-400">
                Free Fire Level Up Pass Instant Delivery
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-6 md:flex-row md:justify-between">
            <div className="flex-1 space-y-3">
              ...
              <ul className="space-y-2 text-xs leading-relaxed text-slate-300 sm:text-sm">
                ...
                <li className="flex gap-2">
                  <span className="text-cyan-400">●</span>
                  Player ID Code ভুল দিয়ে Diamond না পেলে BD21 কর্তৃপক্ষ দায়ী
                  নয়।
                </li>
                <li className="flex gap-2">
                  <span className="text-cyan-400">●</span>
                  Order কমপ্লিট হওয়ার পরেও আইডিতে ডাইমন্ড না গেলে সাপোর্টে
                  মেসেজ দিন।
                </li>
                <li className="flex gap-2">
                  <span className="text-cyan-400">●</span>
                  অর্ডার Cancel হলে কি কারণে তা Cancel হয়েছে তা অর্ডার
                  হিস্টোরিতে দেওয়া থাকে অনুগ্রহ পূর্বক দেখে পুনরায় সঠিক তথ্য
                  দিয়ে অর্ডার করবেন।
                </li>
                ...
                <li className="pl-4 text-xs text-slate-300 space-y-1">
                  <p>
                    1. Level Up pass [Lv.6] -- ওইটা অর্ডার করলে ১২০ ডায়মন্ড
                    পাবেন। অর্ডার করতে হলে আইডি লেভেল ৬ থাকতে হবে ✅
                  </p>
                  <p>
                    2. Level Up pass [Lv.10] -- ওইটা অর্ডার করলে ২০০ ডায়মন্ড
                    পাবেন। অর্ডার করতে হলে আইডি লেভেল ১০ থাকতে হবে ✅
                  </p>
                  <p>
                    3. Level Up pass [Lv.15] -- ওইটা অর্ডার করলে ২০০ ডায়মন্ড
                    পাবেন। অর্ডার করতে হলে আইডি লেভেল ১৫ থাকতে হবে ✅
                  </p>
                  <p>
                    4. Level Up pass [Lv.20] -- ওইটা অর্ডার করলে ২০০ ডায়মন্ড
                    পাবেন। অর্ডার করতে হলে আইডি লেভেল ২০ থাকতে হবে ✅
                  </p>
                  <p>
                    5. Level Up pass [Lv.25] -- ওইটা অর্ডার করলে ২০০ ডায়মন্ড
                    পাবেন। অর্ডার করতে হলে আইডি লেভেল ২৫ থাকতে হবে ✅
                  </p>
                  <p>
                    6. Level Up pass [Lv.30] -- ওইটা অর্ডার করলে ৩৫০ ডায়মন্ড
                    পাবেন। অর্ডার করতে হলে আইডি লেভেল ৩০ থাকতে হবে ✅
                  </p>
                  <p>
                    7. Level Up pass [1270 Diamond] -- ওইটা অর্ডার করলে ১২৭০
                    ডায়মন্ড পাবেন। অর্ডার করতে হলে আইডি লেভেল ৩০ থাকতে হবে
                    উপরের সব গুলা আইডিতে থাকতে হবে ✅
                  </p>
                </li>
              </ul>
            </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 px-4 py-6 backdrop-blur-sm">
          <div className="w-full max-w-md overflow-hidden rounded-3xl border border-cyan-400/20 bg-[#081c36] text-white shadow-2xl">
            <div className="flex items-center justify-between border-b border-white/10 px-5 py-4">
              ...
              <button
                onClick={() => setShowWalletPay(false)}
            ...
            <div className="p-5">
              ...
              {walletBalance < selectedPackage.price ? (
                <>
                  ...
                  <div className="mt-4 grid grid-cols-2 gap-3">
                    ...
                    <button
                      ...
                      className="rounded-xl bg-cyan-400 px-4 py-2.5 text-xs font-black text-[#06172e]"
                    >
                      Add Money
                    </button>
                  </div>
                ...
                <button
                  ...
                  className="mt-4 w-full rounded-xl bg-cyan-400 px-5 py-3.5 text-sm font-black text-[#06172e] disabled:opacity-50"
                >
