          ...
          <div>
            <div className="overflow-hidden rounded-2xl border border-cyan-400/20 bg-[#0b2545]">
              <Image
                ...
                height={700}
                priority
                src="/products/indonesia-server.png"
                width={700}
              />
            </div>
            <div className="mt-4 rounded-2xl border border-cyan-400/20 bg-[#0b2545] p-5">
              <h1 className="text-2xl font-black">
                Indonesia <span className="text-cyan-400">Server</span>
              </h1>
              <p className="mt-2 text-sm leading-6 text-slate-400">
                Free Fire Indonesia Server TopUp
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-6 md:flex-row md:justify-between">
            <div className="flex-1 space-y-3">
              ...
              <div className="space-y-2 text-xs leading-relaxed text-slate-300 sm:text-sm">
                ...
                <p>
                  ⦿ Player ID Code ভুল দিয়ে Diamond না পেলে BD21 কর্তৃপক্ষ
                  দায়ী নয়।
                </p>
                <p>
                  ⦿ Order কমপ্লিট হওয়ার পরেও আইডিতে ডাইমন্ড না গেলে চেক করার
