  ...
  const loadPackages = useCallback(async () => {
    try {
      ...
      if (data && !error && data.length > 0) {
        ...
        setPackages([{ id: "like1", name: "1000 Likes", price: 50 }]);
      }
    } catch (error) {
          ...
          <div>
            <div className="overflow-hidden rounded-2xl border border-cyan-400/20 bg-[#0b2545]">
              <Image
                ...
                height={700}
                priority
                src="/products/ff-likes.png"
                width={700}
              />
            </div>
            <div className="mt-4 rounded-2xl border border-cyan-400/20 bg-[#0b2545] p-5">
              <h1 className="text-2xl font-black">
                FF <span className="text-cyan-400">Likes</span>
              </h1>
              <p className="mt-2 text-sm leading-6 text-slate-400">
                Free Fire Profile Likes Increasing Service
              </p>
            </div>
          </div>
            ...
            <div className="flex-1 space-y-3">
              ...
              <div className="space-y-2 text-xs leading-relaxed text-slate-300 sm:text-sm">
                <p className="font-bold text-cyan-300">
                  📢 অর্ডার করার আগে ভালোভাবে পড়ে নিন!
                </p>
                <p>✅ এক আইডিতে প্রতিদিন একবার অর্ডার করতে পারবেন।</p>
                <p>
                  ❌ একই দিনে একই আইডিতে বারবার অর্ডার করলে টাকা ফেরত দেওয়া হবে
                  না।
                </p>

                <div className="pt-2 font-bold text-white">
                  👍 Likes Package সংক্রান্ত গুরুত্বপূর্ণ তথ্য:
                </div>
                <ul className="pl-4 space-y-1 text-xs text-slate-300">
                  <li>
                    • 200 Likes ⇨ Instant Delivery (আইডিতে ঢুকে থাকলে বের হয়ে
                    আবার ঢুকলে লাইক যোগ হয়ে যাবে)
                  </li>
                  <li>
                    • 400 Likes ⇨ 2 Days Package (প্রতিদিন ২০০ করে লাইক ডেলিভারি
                    হবে)
                  </li>
                  <li>
                    • 600 Likes ⇨ 3 Days Package (প্রতিদিন ২০০ করে লাইক ডেলিভারি
                    হবে)
                  </li>
                  <li>
                    • 1400 Likes ⇨ 7 Days Package (প্রতিদিন ২০০ করে লাইক
                    ডেলিভারি হবে)
                  </li>
                  <li>
                    • 3000 Likes ⇨ 15 Days Package (প্রতিদিন ২০০ করে লাইক
                    ডেলিভারি হবে)
                  </li>
                  <li>
                    • 6000 Likes ⇨ 1 Month Package (প্রতিদিন ২০০ করে লাইক
                    ডেলিভারি হবে)
                  </li>
                  <li>
                    • 12000 Likes ⇨ 2 Month Package (প্রতিদিন ২০০ করে লাইক
                    ডেলিভারি হবে)
                  </li>
                  <li>
                    • 18000 Likes ⇨ 3 Month Package (প্রতিদিন ২০০ করে লাইক
                    ডেলিভারি হবে)
                  </li>
                  <li>
                    • 36000 Likes ⇨ 6 Month Package (প্রতিদিন ২০০ করে লাইক
                    ডেলিভারি হবে)
                  </li>
                  <li>
                    • 73000 Likes ⇨ 1 Year Package (প্রতিদিন প্রায় ২০০ করে লাইক
                    ডেলিভারি হবে)
                  </li>
                </ul>

                <p className="pt-2 font-bold text-cyan-300">
                  ⚠️ ডেলিভারি নিয়ম ও সহায়তা:
                </p>
                <p>
                  • Instant package সাথে সাথে ডেলিভারি হবে। Long-term package
                  গুলোতে প্রতিদিন নির্দিষ্ট পরিমাণ লাইক ডেলিভারি হবে।
                </p>
                <p>
                  • নির্ধারিত সময়ের মধ্যে লাইক না পেলে আমাদের Customer
